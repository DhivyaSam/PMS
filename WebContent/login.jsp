            ...
            <div class="row">
              <form class="" action="index.html" method="post">
                <div class="form-group">
                  <div class="col-md-2">
                    <label class="labelname" for="">Username</label>
                  </div>
                  <div class="col-md-3">
                    <input type="text" class="form-control" name="username" value="" style="width:250px;">
                  </div>
                </div>
              </div>
                <div class="row" id="loginid">
                  ...
                  <div class="col-md-3">
                    <input type="password" class="form-control" name="password" value="" style="width:250px;">
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-2">
